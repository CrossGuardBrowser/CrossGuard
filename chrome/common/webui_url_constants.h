...
// CrossGuard 原生 AI chat side panel
inline constexpr char kChromeUICrossGuardChatHost[] = "crossguard-chat.top-chrome";
inline constexpr char kChromeUICrossGuardChatURL[] =
    "chrome-untrusted://crossguard-chat.top-chrome/";
