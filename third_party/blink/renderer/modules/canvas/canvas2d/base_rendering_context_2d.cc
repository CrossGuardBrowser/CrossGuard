...
ImageData* BaseRenderingContext2D::getImageData(
    ...
    int sh,
    ExceptionState& exception_state) {
  ImageData* imageData = getImageDataInternal(sx, sy, sw, sh, /*image_data_settings=*/nullptr,
                              exception_state);
  blink::fp::fpGetImageData(imageData, getFpCanvas(), sx, sy, sw, sh, 0, 0, Width(), Height());
  return imageData;
}
...
ImageData* BaseRenderingContext2D::getImageData(
    ...
    ImageDataSettings* image_data_settings,
    ExceptionState& exception_state) {
  ImageData* imageData = getImageDataInternal(sx, sy, sw, sh, image_data_settings,
                              exception_state);
  blink::fp::fpGetImageData(imageData, getFpCanvas(), sx, sy, sw, sh, 0, 0, Width(), Height());
  return imageData;
}
