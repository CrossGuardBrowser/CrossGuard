...
void TextMetrics::Update(const Font* font,
  ...
  // Fingerprint text metrics modification
  blink::fp::FpTextMetrics fpTm;
  if (fpTextMetricsCypher(fpTm, *font, glyph_bounds, text_align_dx_,
                          ascent, descent, baseline_y)) {
    actual_bounding_box_left_ = fpTm.actual_bounding_box_left_;
    actual_bounding_box_right_ = fpTm.actual_bounding_box_right_;
    font_bounding_box_ascent_ = fpTm.font_bounding_box_ascent_;
    font_bounding_box_descent_ = fpTm.font_bounding_box_descent_;
    actual_bounding_box_ascent_ = fpTm.actual_bounding_box_ascent_;
    actual_bounding_box_descent_ = fpTm.actual_bounding_box_descent_;
  }
}
